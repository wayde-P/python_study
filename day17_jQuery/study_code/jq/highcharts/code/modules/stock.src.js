...
(function (factory) {
    ...
    (function (H) {
        ...
        seriesProto.processData = function () {
            ...
            skip = baseProcessData.apply(series, arguments) === false || !groupingEnabled || !visible;
            if (!skip) {
    ...
    (function (H) {
        ...
        wrap(Series.prototype, 'render', function (proceed) {
            ...
            if (!(this.chart.is3d && this.chart.is3d()) && !this.chart.polar &&
                this.xAxis && !this.xAxis.isRadial // Gauge, #6192
            ) {
